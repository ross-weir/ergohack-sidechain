{
  ...
  //  R7: (Coll[Byte])  parent  - Link to previous state: hash(h  T_h  U_h).
  ...
  // TODO: validate content of the state transition
  val validStateTransition = successor.R4[Int].isDefined &&
